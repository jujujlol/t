...
def get_radio_metadata():
    url = "https://metadata-api.mytuner.mobi/api/v1/metadata-api/web/metadata?app_codename=mytuner_website&radio_id=396283&time=1730853134328"
    headers = {
        "Authorization": "HMAC mytuner_website:vwR8rYTh8aqirrEIHdFFUIQp6T1fGgJco9H0YuBYsTc"
    }
...
def send_discord_webhook(webhook_url, song_info):
    try:
        ...
        # Verificar que tenemos una cancion valida
        if not song_data:
...
def main():
    webhook_url = "https://discord.com/api/webhooks/1303501580175413269/qD_QjO3GViKu-FPvJlXgrMpJo0gdBGFrX8djeAoHbgCdQHpkQziBNpIFiAavM2Pk7HhL"
    last_song = None
    error_count = 0
    ...
    while True:
        try:
            ...
            if current_data:
                ...
                # Solo procesar si tenemos una cancion valida y es diferente a la anterior
            ...
            # Si hay muchos errores consecutivos, esperar mas tiempo
            if error_count > 5:
